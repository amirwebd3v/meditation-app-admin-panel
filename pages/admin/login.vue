      ...
      <v-row align="center" justify="center">
        <v-col cols="12" sm="8" md="6" lg="4">
          <v-card class="mx-auto bg-transparent" elevation="0" width="400">
            ...
            <v-text-field density="compact" placeholder="Enter Email" variant="outlined"></v-text-field>
            <v-text-field :append-inner-icon="visible ? 'mdi-eye-off' : 'mdi-eye'" :type="visible ? 'text' : 'password'"
                          density="compact" placeholder="Enter Password" variant="outlined"
                          @click:append-inner="visible = !visible"/>
            <v-card class="mb-12" color="surface-variant" variant="tonal"/>
            <v-btn block="" rounded="xl" class="mb-8" color="primary" size="large" variant="flat">Login</v-btn>
          </v-card>
        </v-col>
      </v-row>
    </v-container>
